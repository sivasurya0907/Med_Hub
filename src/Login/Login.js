...
//       toast.success('Account Created-Enjoy MedHub', {
//         position: "top-center",
//         autoClose: 5000,
//         hideProgressBar: false,
//         closeOnClick: true,
...
//                   <a href="mailto:itssuryaofficial17@gmail.com">Forgot Password?</a>
//                   <br />
//                   <br />
//                   <center>
//                     <p>OR</p>
            ...
            <div className="login-form">
              <div className="sign-in-htm">
                ...
                <div className="group">
                  ...
                  <input ref={PasswordRef} id="pass" type="password" className="input" data-type="password" required />
                </div>
                <div className="group">
                  <input id="check" type="checkbox" className="check" />
                  <label htmlFor="check">
              ...
              <div className="sign-up-htm">
                ...
                <div className="group">
                  ...
                  <input ref={repeatPasswordRef} id="pass" type="password" className="input" data-type="password" required />
                </div>
                <div className="group">
                  <label htmlFor="pass" className="label">
                    Email Address
                  </label>
                  <input ref={emailRef} id="email" type="text" className="input" required />
                </div>
                <br />
                <div className="group">
                  <center>
